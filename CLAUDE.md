...
- Nothing reads the vendors' billing APIs — every date and amount is manually maintained, which the panel says out loud. Never store card numbers or passwords here (`payment_method` is a label like "Amex ••1234").
