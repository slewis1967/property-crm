      ...
      <body className="bg-gray-50 text-gray-900 h-screen overflow-hidden">
        <AppShell
          ...
          <nav className="flex-1 p-4 space-y-1 overflow-y-auto">
            ...
            <a href="/health" className="flex items-center gap-3 px-3 py-2 rounded-lg hover:bg-gray-800 text-gray-300 hover:text-white transition text-sm">
            ...
            <Link href="/properties/map" className="flex items-center gap-3 px-3 py-2 rounded-lg hover:bg-gray-800 text-gray-300 hover:text-white transition text-sm">
              <span>🗺️</span> Stock Map
            </Link>
