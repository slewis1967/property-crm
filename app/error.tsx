...
/**
 * Root error boundary. Without this, any thrown server-component or render
 * error showed Next's raw crash screen. This catches it, logs to the
 * browser console (and the digest server-side), and gives a recover action.
 */
export default function Error({
  ...
  useEffect(() => {
    console.error("[crm] unhandled error", {
